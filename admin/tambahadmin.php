...
<body>
	<center>
		<div style="width:45%" align="left">
			...
			<br><h2 class="jdlatas" align="center" id="toform">TAMBAH ADMIN</h2><br><br>
			...
			<form method="POST" action="tambahadmin2.php" onSubmit="return validasi()">
				...
				<input type="submit" style="width:100%"  type="button" class="btn btn-success" value="Buat">
