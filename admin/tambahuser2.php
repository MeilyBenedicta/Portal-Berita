...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if($err_username=="0" & $err_password=="0" & $err_nama=="0" & $err_email=="0")
	{
		...
		else
		{
			...
			header("location: tambahuser.php?err_username=$err_username&err_email=$err_email&err_password=$err_password&err_nama=$err_nama#toform");
		}
	}

	else
	{
		header("location: tambahuser.php?err_username=$err_username&err_password=$err_password&err_nama=$err_nama&err_email=$err_email#toform");
	}
